...
scheduled_day: 4
module_id: 1
subtitle: 'Preview the five course guiding questions as analytical tools, and introduce ethical frameworks as a vocabulary to develop all semester.'
status: unverified
status_reviewer:
status_date:
status_notes:
...
Module 1 now turns to the three foundational concepts that underlie both human and machine intelligence: knowledge, learning, and intelligence. Module 2 will build on this foundation by examining the technical mechanisms through which AI systems operationalize these concepts.
