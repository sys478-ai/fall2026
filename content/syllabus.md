...
### NSF Research Project on Societal Implications of AI

The course includes a recurring case study connected to an NSF-funded research project on a new kind of brain-inspired computing technology. Researchers on the project are developing computer hardware that borrows ideas from how the cerebellum learns and responds to unexpected patterns. Because the technology is still being developed, it gives us a chance to think ahead about its possible uses and consequences rather than waiting until those uses are already established. Throughout the semester, we will use the project to ask how an emerging AI technology works, where it might be deployed, who might benefit or be affected, and what questions designers, institutions, policymakers, and the public should be asking now.
...
1. **What kind of intelligence or capability is at issue?**
What are humans or machines actually doing – learning, predicting, classifying, judging, generating, noticing anomalies – and what forms of human knowledge or intelligence are being augmented, changed, or displaced?

2. **How do various AI systems work from a technical perspective?**
What data, models, algorithms, hardware, infrastructure, and computational processes make it work?

3. **How do these same systems work from a social perspective?**
What assumptions, values, institutions, incentives, labor, and power relations shape how it is designed, deployed, and used?

4. **What happens when AI enters a particular institution or domain?**
How does the existing context already work, who has authority, what inequalities or tensions already exist, and what changes when AI is introduced?

5. **What should be done?**
Who benefits and who bears risks? What should be adopted, limited, redesigned, governed, preserved, contested, or refused – and who should get to decide?
...
### Reading Preparation & Participation

This portion of the grade reflects your preparation for class discussion and your contributions to our work as a learning community. You are expected to complete assigned readings and other materials before class and to arrive ready to ask questions, make connections, and work through difficult ideas with others.
...
Homework and labs are the main applied work of the course. Labs make technical systems concrete so that we can examine their ethical, legal, and societal implications. Homework extends that work through analysis, writing, and other assignments connected to the week's questions.

Specific instructions, due dates, and submission expectations will be posted with each assignment.

### Development Activities

The course includes a career-readiness strand. Over the semester, you will complete professional development activities that help you clarify goals, communication skills, and reflective career materials. These activities support both your life after college and the final project.

### Applied AI & Society Final Project

The final project is a senior-level public-facing artifact that helps non-specialists reason about an emerging AI system and its possible futures. It may take the form of an explainer, governance brief, exhibit, memo set, presentation, or other stakeholder-facing resource.
...
Use of GenAI will vary from assignment to assignment. Please read the assignment instuctions carefully and ask the instructor if you have any questions.
