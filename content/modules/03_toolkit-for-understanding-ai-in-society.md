...
color: emerald
excerpt: 'You will build an analytical toolkit for AI in society: how the world becomes data, what counts as skill and expertise, how predictions become decisions, and whether predictions are ever neutral.'
unit_focus: 'In this unit, you will build a toolkit for analyzing AI as a sociotechnical system, connecting classification and data to skill, decision thresholds, error, and the construction of norms.'
priority: low
---
...
1. `How Does the World Become Data, and Why Is AI a Sociotechnical System?`
2. `What Counts as Skill and Expertise?`
3. `How Do Predictions Become Decisions?`
4. `Are Predictions Ever Neutral? Norms, Bias, and Technological Solutionism`
