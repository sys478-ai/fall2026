...
const FIELD_GUIDE_BANNER_CLASSES: Record<FieldGuidePalette, FieldGuideBannerClasses> = {
  patterns: {
    header: 'border-y border-rose-200 bg-rose-50 px-4 py-16 dark:border-rose-900 dark:bg-rose-950/30 md:px-16',
    label: 'text-rose-800 dark:text-rose-300',
    featured:
      'group inline-flex items-center gap-3 rounded-xl border border-rose-200 bg-rose-50 px-5 py-4 no-underline transition-colors hover:border-rose-300 hover:bg-rose-100 dark:border-rose-900 dark:bg-rose-950/30 dark:hover:border-rose-800 dark:hover:bg-rose-950/50',
    featuredLabel: 'text-rose-700 dark:text-rose-400',
    featuredTitleHover: 'group-hover:text-rose-800 dark:group-hover:text-rose-300',
    featuredArrow: 'text-rose-600 dark:text-rose-400',
    cardImageBg: 'bg-rose-50 dark:bg-rose-950/30',
    cardLabel: 'text-rose-800 dark:text-rose-300',
    cardTitleHover: 'group-hover:text-rose-800 dark:group-hover:text-rose-300',
    cardBorderHover: 'hover:border-rose-300 dark:hover:border-rose-800',
    previewBadge: 'bg-rose-100 text-rose-800 dark:bg-rose-900/50 dark:text-rose-200',
    sheetHeader: 'border-b border-rose-200 bg-rose-50 px-6 py-5 dark:border-rose-900 dark:bg-rose-950/30',
    previewCardHover: 'hover:border-rose-300 hover:bg-rose-50/50 dark:hover:border-rose-700 dark:hover:bg-rose-950/20',
    previewTitleHover: 'group-hover:text-rose-800 dark:group-hover:text-rose-300',
    moreLink: 'text-rose-800 no-underline hover:text-rose-900 dark:text-rose-300 dark:hover:text-rose-200',
  },
  sts: {
