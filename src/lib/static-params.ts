 ...
 */
export function getPlaceholderSlug(contentType: 'activities' | 'assignments' | 'resources' | 'exams' | 'career-modules' | 'ai-deployment-patterns' | 'sts-concepts'): string {
  const singularMap: Record<typeof contentType, string> = {
    ...
    'ai-deployment-patterns': 'recognition-card',
 ...
 */
export function isPlaceholderSlug(slug: string, contentType: 'activities' | 'assignments' | 'resources' | 'exams' | 'career-modules' | 'ai-deployment-patterns' | 'sts-concepts'): boolean {
...
export async function generateStaticParamsForContentType(
  contentType: 'activities' | 'assignments' | 'resources' | 'exams' | 'career-modules' | 'ai-deployment-patterns' | 'sts-concepts'
...
export function validatePostForRender(
  slug: string,
  postData: PostData,
  contentType: 'activities' | 'assignments' | 'exams' | 'resources' | 'career-modules' | 'ai-deployment-patterns' | 'sts-concepts'
): boolean {
